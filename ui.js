...
export const ui = {
    ...
    modeBrowse:     gid("mode-browse"),
    playPane:       gid("play-pane"),
    editorPane:     gid("editor-pane"),
    browserPane:    gid("browser-pane"),
    browserList:    gid("browser-list"),
    browserPreview: gid("browser-preview"),
    browserPlayBtn: gid("browser-play-btn"),
